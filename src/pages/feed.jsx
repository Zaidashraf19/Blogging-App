  ...
  return (
    <>
      <div className="px-3 py-1 flex justify-between bg-[#3e3b81] text-white">
        <Link to={"addpost"}>
          <button className="border border-[#dddfe2] rounded bg-black text-white cursor-pointer p-3 items-center text-center">
            Add Post
          </button>
        </Link>
        <button
        ...
        {post.map((item, index) => {
          return (
            <div key={item.id} className="bg-white rounded shadow w-70">
              ...
              <div>
                <img src={item.imgURL} className="w-full my-2" />
              </div>
